        ...
        while running:
            ...
            if len(command) == 2:
                if command[0] == "r" or command[0] == "rot" or command[0] == "rotation":
                    dave.rot_servo.set_angle(float(command[1]))
                elif command[0] == "b":
                    dave.b_servo.set_angle(float(command[1]))
                elif command[0] == "a":
                    dave.a_servo.set_angle(float(command[1]))
                elif command[0] == "c" or command[0] == "claw":
                    dave.claw_servo.set_angle(float(command[1]))
            elif len(command) == 3:
                if command[0] == "go" or command[0] == "move":
                    dave.move(float(command[1]), float(command[2]))
            else:
                if command[0] == "q" or command[0] == "quit":
                    ...
                    dave.b_servo.set_angle(80, dave.b_servo.rest)
                elif command[0] == "down":
                    dave.b_servo.set_angle(0, dave.b_servo.rest)
                elif command[0] == "left":
                    dave.rot_servo.set_angle(-80, dave.b_servo.rest)
                elif command[0] == "right":
                    dave.rot_servo.set_angle(80, dave.b_servo.rest)
                elif command[0] == "back":
                    dave.a_servo.set_angle(-70, dave.b_servo.rest)
